import { GET_CONTENT } from "@/constants/API";
import { useGetApiQuery } from "@/redux/api/AuthApi";
import React from "react";
import Navbar from "../Navbar";
import Footer from "../Footer";
export const ContentPolicy = () => {
  const { data, isError, isLoading } = useGetApiQuery({ api: GET_CONTENT });
      ...
      <div className="mb-[2rem] md:mb-[7rem]">
        ...
        <div className="md:mx-[6rem] ">
          <div className="mt-10 mx-4 lg:mx-10">
            ...
            <h1
              className="md:text-[18px] text-[16px] text-gray-800  text-justify"
