...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const trigger = useRef<HTMLButtonElement>(null); // Specify HTMLButtonElement type
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-[99999] flex h-screen w-72.5 flex-col overflow-y-hidden  bg-white shadow-xl duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6  py-5.5 lg:py-6.5">
        <NavLink to="/">
        <Logo className='object-contain h-auto w-60 max-w-xs mx-auto cursor-pointer transition-transform duration-300 transform hover:scale-110' style={{ marginTop: '20px' }} />
      ...
      <div className=" overflow-y-auto hide-scrollbar   flex flex-col duration-300  ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-10 md:py-4 px-4 lg:mt-4  lg:px-6">
          {/* <!-- Menu Group --> */}
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 text-black font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                'group relative flex items-center gap-2.5 rounded-md px-4  text-black font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ' +
                                (isActive && '!text-black')
                              }
                            >
                              eCommerce
              ...
              <li>
                <NavLink
                  to="/calendar"
                  className={`group relative flex items-center gap-2.5 text-black rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
            ...
            <CiEdit />
             ...
             <TfiWrite />
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 text-black font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm text-black py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/forms' ||
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              ...
                              className=
                                'group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out text-black ' 
          ...
          {/* <!-- Others Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm  text-black font-semibold text-bodydark2">
              OTHERS
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 text-black  px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative flex items-center gap-2.5 rounded-sm text-black px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                        ...
                        <ul className="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                          ...
                          <li>
                            <NavLink
                              to="/ui/buttons"
                              className={({ isActive }) =>
                                'group relative flex items-center text-black gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-black ' +
                                (isActive && '!text-black')
                              }
                            >
                              Buttons
                ...
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <NavLink
                        to="#"
                        className={`group relative text-black flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                          (pathname === '/auth' || pathname.includes('auth')) &&
                          'bg-graydark dark:bg-meta-4'
                        }`}
                        onClick={(e) => {
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/adminlogin"
                              className={
                                'group relative flex items-center text-black  gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out ' 
                          ...
                          <li>
                            <NavLink
                              to="/auth/signup"
                              className={
                                'group relative 9 flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out text-black ' 
